...
layout: post
tags: programming, xunit, tdd
---
Finally got around to implementing this for Xunit since I needed for something (to be blogged soon too ;)). Copied from the [project page](https://github.com/kzu/xunit.assemblyfixture). Enjoy!
